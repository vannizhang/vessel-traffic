...
const DownloadScreen:React.FC<Props> = ({
    ...
    const getUrlForZippedPackage = ():string=>{
        ...
        return `${HOST_SERVER_URL}/AIS_Tracks_${year}_${monthStr}.gdb.zip`
    }
